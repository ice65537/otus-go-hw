...
func easyjsonE3ab7953EncodeGithubComIce65537OtusGoHwHw10ProgramOptimization1(out *jwriter.Writer, in User) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v User) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE3ab7953EncodeGithubComIce65537OtusGoHwHw10ProgramOptimization1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *User) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE3ab7953DecodeGithubComIce65537OtusGoHwHw10ProgramOptimization1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *User) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE3ab7953DecodeGithubComIce65537OtusGoHwHw10ProgramOptimization1(l, v)
}
