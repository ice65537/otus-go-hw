...
func TestGetDomainStat_Time_And_Memory2(t *testing.T) {
	bench := func(b *testing.B) {
		b.Helper()
		b.StopTimer()
...
func TestGetDomainStat_Time_And_Memory3(t *testing.T) {
	bench := func(b *testing.B) {
		b.Helper()
		b.StopTimer()
		...
		b.StartTimer()
		FullMemoryRead = true
		UseJsonBugerVsIter = true // default
		stat, err := GetDomainStat(data, "biz")
		b.StopTimer()
		require.NoError(t, err)
		require.Equal(t, expectedBizStat, stat)
